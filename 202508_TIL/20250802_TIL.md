...
프로그램 실행 중 발생할 수 있는 오류(예외)에 대비하여 프로그램이 비정상적으로 종료되는 것을 막고, 정상적인 실행 상태를 유지하기 위해 사용합니다. [9, 11, 20] 예외 처리를 통해 개발자는 예상치 못한 문제에 대응하는 코드를 작성할 수 있으며, 오류 발생 시 로그를 남겨 디버깅을 용이하게 할 수 있습니다. 
